<cfscript>
    component name="PayErrorList" output="false" hint="I define the properties and methods" {
        ...
        public PayErrorList function init(PayError payError="") hint="I initialize the component and return myself" output="false" {
            ...
            if(isStruct(local.json)) {
                ...
                for(key in local.json) {
                    ...
                    if('#key#' eq 'payError') {
                        ...
                        var keyObj = createObject("component", 'payError');
