<cfscript>
    component name="GetAllowedFundingSourcesRequest" output="false" hint="I define the properties and methods" {
        ...
        public GetAllowedFundingSourcesRequest function init(RequestEnvelope requestEnvelope="", string key="") hint="I initialize the component and return myself" output="false" {
