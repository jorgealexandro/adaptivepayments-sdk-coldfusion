<cfscript>
    component name="FundingConstraint" output="false" hint="I define the properties and methods" {
        ...
        public FundingConstraint function init() hint="I initialize the component and return myself" output="false" {
            ...
            if(isStruct(local.json)) {
                ...
                for(key in local.json) {
                    ...
                    if('#key#' eq 'allowedFundingType') {
                        ...
                        var keyObj = createObject("component", 'allowedFundingType');
