<cfscript>
    component name="GetFundingPlansRequest" output="false" hint="I define the properties and methods" {
        ...
        public GetFundingPlansRequest function init(RequestEnvelope requestEnvelope="", string payKey="") hint="I initialize the component and return myself" output="false" {
