<cfscript>
    component name="GetShippingAddressesResponse" output="false" hint="I define the properties and methods" {
        ...
        public GetShippingAddressesResponse function init(ResponseEnvelope responseEnvelope="") hint="I initialize the component and return myself" output="false" {
            ...
            if(isStruct(local.json)) {
                ...
                for(key in local.json) {
                    ...
                    if('#key#' eq 'selectedAddress') {
                        ...
                        var keyObj = createObject("component", 'selectedAddress');
