<cfscript>
    component name="RefundInfoList" output="false" hint="I define the properties and methods" {
        ...
        public RefundInfoList function init(RefundInfo refundInfo="") hint="I initialize the component and return myself" output="false" {
            ...
            if(isStruct(local.json)) {
                ...
                for(key in local.json) {
                    ...
                    if('#key#' eq 'refundInfo') {
                        ...
                        var keyObj = createObject("component", 'refundInfo');
