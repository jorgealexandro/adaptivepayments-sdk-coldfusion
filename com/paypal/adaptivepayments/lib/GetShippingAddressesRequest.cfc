<cfscript>
    component name="GetShippingAddressesRequest" output="false" hint="I define the properties and methods" {
        ...
        public GetShippingAddressesRequest function init(RequestEnvelope requestEnvelope="", string key="") hint="I initialize the component and return myself" output="false" {
