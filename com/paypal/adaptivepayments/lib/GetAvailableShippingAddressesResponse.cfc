<cfscript>
    component name="GetAvailableShippingAddressesResponse" output="false" hint="I define the properties and methods" {
        ...
        public GetAvailableShippingAddressesResponse function init(ResponseEnvelope responseEnvelope="") hint="I initialize the component and return myself" output="false" {
            ...
            if(isStruct(local.json)) {
                ...
                for(key in local.json) {
                    ...
                    if('#key#' eq 'availableAddress') {
                        ...
                        var keyObj = createObject("component", 'availableAddress');
