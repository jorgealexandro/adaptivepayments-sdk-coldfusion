<cfscript>
    component name="CancelPreapprovalRequest" output="false" hint="I define the properties and methods" {
        ...
        public CancelPreapprovalRequest function init(RequestEnvelope requestEnvelope="", string preapprovalKey="") hint="I initialize the component and return myself" output="false" {
