<cfscript>
    component name="FundingTypeList" output="false" hint="I define the properties and methods" {
        ...
        public FundingTypeList function init(FundingTypeInfo fundingTypeInfo="") hint="I initialize the component and return myself" output="false" {
            ...
            if(isStruct(local.json)) {
                ...
                for(key in local.json) {
                    ...
                    if('#key#' eq 'fundingTypeInfo') {
                        ...
                        var keyObj = createObject("component", 'fundingTypeInfo');
