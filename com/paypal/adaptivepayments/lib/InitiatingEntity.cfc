<cfscript>
    component name="InitiatingEntity" output="false" hint="I define the properties and methods" {
        ...
        public InitiatingEntity function init() hint="I initialize the component and return myself" output="false" {
            ...
            if(isStruct(local.json)) {
                ...
                for(key in local.json) {
                    ...
                    if('#key#' eq 'institutionCustomer') {
                        ...
                        var keyObj = createObject("component", 'institutionCustomer');
