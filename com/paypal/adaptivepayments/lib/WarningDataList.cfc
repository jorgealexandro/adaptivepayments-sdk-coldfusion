<cfscript>
    component name="WarningDataList" output="false" hint="I define the properties and methods" {
        ...
        public WarningDataList function init(WarningData warningData="") hint="I initialize the component and return myself" output="false" {
            ...
            if(isStruct(local.json)) {
                ...
                for(key in local.json) {
                    ...
                    if('#key#' eq 'warningData') {
                        ...
                        var keyObj = createObject("component", 'warningData');
