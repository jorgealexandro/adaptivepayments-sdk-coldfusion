<cfscript>
    component name="AddressList" output="false" hint="I define the properties and methods" {
        ...
        public AddressList function init(Address address="") hint="I initialize the component and return myself" output="false" {
            ...
            if(isStruct(local.json)) {
                ...
                for(key in local.json) {
                    ...
                    if('#key#' eq 'address') {
                        ...
                        var keyObj = createObject("component", 'address');
